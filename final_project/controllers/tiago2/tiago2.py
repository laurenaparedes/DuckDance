...
###################
if mode == 'planner':
    start_w = (12.9356, 24.8258) # Pose_X, Pose_Z in meters
    end_w = (25.4329, 16.2008) # Pose_X, Pose_Z in meters
...
while robot.step(timestep) != -1 and mode != 'planner':
    ...
    # https://stackoverflow.com/questions/65945883/adding-delay-to-robot-controller-in-webots
